    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview ${fn:startsWith(param.param,'work_record_') ? 'active' : ''}">
          ...
          <ul class="treeview-menu">
            <li class="${param.param == 'work_record_my' ? 'active' : ''}"><a href="/sale/my/list"><i class="fa fa-circle-o"></i> 我的销售机会</a></li>
          </ul>
        </li>
        ...
        <li class="treeview ${fn:startsWith(param.param,'charts_') ? 'active' : ''}">
          ...
          <ul class="treeview-menu ">
            <li class="${param.param == 'charts_level' ? 'active' : '' }"><a href="/charts/level"><i class="fa fa-circle-o"></i>客户级别统计</a></li>
            <li class="${param.param == 'charts_deal' ? 'active' : '' }"><a href="/charts/deal"><i class="fa fa-circle-o"></i>漏斗图</a></li>
          </ul>
        </li>
        
        
        <li ${fn:startsWith(param.param,'disk_') ? 'active' : ''}><a href="/disk/home"><i class="fa fa-share-alt"></i> <span>公司网盘</span></a></li>
        <li class="header">系统管理</li>
        <!-- 部门员工管理 -->
        <li ${fn:startsWith(param.param,'account_') ? 'active' : ''}><a href="/account/list"><i class="fa fa-users"></i> <span>员工管理</span></a></li>
